...
- `docs/pdf/executive-summary.pdf` — generated by `scripts/generate-executive-pdf.py`
...
- Scripts: `scripts/sanitize-docs.py` (PII replacement), `scripts/convert-md-to-docs.py` (md→docx/pdf), `scripts/generate-*.py` (5 PDF generators)
- PDFs: `docs/pdf/` — all generated PDFs (executive-summary, demo-guide, slide-outline, user-guide, faqs)

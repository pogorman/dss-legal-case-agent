...
class FaqsPDF(FPDF):
    ...
    def header(self):
        ...
        self.cell(0, 6, sanitize_text("Agent Fidelity Spectrum for Copilot Studio  |  FAQs"), align="L")
...
def build_pdf():
    ...
    pdf.qa_pair(
        ...
        "After 210 baseline test runs across 21 agent configurations and 10 prompts each, specific "

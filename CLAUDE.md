...
- `docs/pdf/phase-1/improving-agents-whitepaper-v1.pdf` — generated by `scripts/generate-executive-pdf.py`
- `docs/pdf/phase-2/improving-agents-whitepaper-v2.pdf` — generated by `scripts/generate-executive-pdf-v2.py` (adds UC3 Policy Compliance)
- `docs/pdf/phase-1/demo-guide.pdf` — generated by `scripts/generate-demo-guide-pdf.py`
- `docs/pdf/phase-1/slide-outline.pdf` — generated by `scripts/generate-slide-outline-pdf.py`
...
- `docs/pdf/phase-1/dataverse-mcp-server-testing.pdf` — generated by `scripts/generate-dv-testing-pdf.py` (reads from `docs/dataverse-mcp-server-testing.md`)
- `docs/pdf/phase-1/demo-cheat-sheet.pdf` — generated by `scripts/generate-cheat-sheet-pdf.py` (hardcoded one-page layout)
- `docs/pdf/phase-1/document-hygiene-brief.pdf` — generated by `scripts/generate-doc-hygiene-brief-pdf.py` (one-page briefing for David Smith/Rod Davis)
- `docs/pdf/phase-2/phase-2-custom-connector.pdf` — phase 2 custom connector doc

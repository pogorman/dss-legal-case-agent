...
To update content, edit the Python script directly and regenerate.
...
- Scripts: `scripts/sanitize-docs.py` (PII replacement), `scripts/convert-md-to-docs.py` (md→docx/pdf), `scripts/generate-*.py` (6 PDF generators), `scripts/generate-slide-deck.py` (PowerPoint)
